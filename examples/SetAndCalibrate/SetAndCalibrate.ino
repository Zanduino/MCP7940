...
** data sheet for the MCP7940M is located at                                                      **
...
** chip as well.                                                                                  **
**                                                                                                **
** On-chip digital trimming can be used to adjust for frequency variance caused by crystal        **
** tolerance and temperature. Since the chip only outputs full seconds, a calibration cycle won't **
** be effective until there is at least one second difference between the RTC time and real time, **
** and this might take a day or more to do, particularly if the RTC and crystal is already close  **
** to being accurate.                                                                             **
**                                                                                                **
